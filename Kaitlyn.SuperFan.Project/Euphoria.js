...
function reStart(elem){
	document.getElementById("julesmusic").pause();
	preVious("none","none","page");
	girl1 = true;
	checkDone();
}
//Child Algorithm 1//
function preVious(input1,input2,input3){
pagec.classList.add("input1");
page.classList.remove("input2");
pageb.classList.add("input3");
}
function theEnd(elem){
	preVious("none","none","page3");
	console.log("hey");
}
//child algorithm2//
